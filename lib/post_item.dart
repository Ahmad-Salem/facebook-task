...
class PostItem extends StatefulWidget {
  ...
  PostItem(this.reactions, this.post_id, this.post_user_name, this.post_date,
      this.post_photo, this.post_likes, this.post_comments);


  @override
  _PostItemState createState() => _PostItemState(post_id, post_user_name, post_date,
      post_photo, post_likes, post_comments);
...
class _PostItemState extends State<PostItem> {
  ...
  _PostItemState(this.post_id, this.post_user_name, this.post_date,
      this.post_photo, this.post_likes, this.post_comments);
